-- Respeita edições manuais de fim/status no cronograma (não sobrescreve após cada patch).
...
begin
  ...
  -- Marca atraso só para status ainda abertos (não força quem já está em andamento/atrasado manualmente)
  update public.activities
  set status = 'delayed'
