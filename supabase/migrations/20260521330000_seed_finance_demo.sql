-- Seed financeiro demo — ver supabase/seed-finance-demo.sql (cópia para migrations)
-- Popula recebíveis, custos, horas e margens nos projetos [DEMO]
...
update public.projects set
  invoiced_at  = case id
    when '22222222-2222-4222-8222-222222220001' then '2026-04-10'::date
  ...
  received_at = case id
    when '22222222-2222-4222-8222-222222220005' then '2026-05-05'::date
...
delete from public.project_costs where description like '[FIN-DEMO]%';
...
delete from public.time_sessions where description like '[FIN-DEMO]%';
